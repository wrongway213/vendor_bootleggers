...
ADDONSU_INSTALL_TARGET := $(PRODUCT_OUT)/addonsu-$(BOOTLEGGERS_BUILD_VERSION)-$(TARGET_ARCH).zip
...
ADDONSU_REMOVE_TARGET := $(PRODUCT_OUT)/addonsu-remove-$(BOOTLEGGERS_BUILD_VERSION)-$(TARGET_ARCH).zip
